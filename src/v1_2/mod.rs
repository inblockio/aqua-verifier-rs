...
use aqua_verifier_rs_types::models::revision::{Revision, RevisionReference};
...
pub fn prev_v1_1_to_ref_v1_2(prev: &Revision) -> RevisionReference {
    RevisionReference {
        reference_hash: Hash::default(),
